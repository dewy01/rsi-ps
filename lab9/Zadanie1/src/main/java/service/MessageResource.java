...
public class MessageResource {
    ...
    public Message getMessage(@PathParam("messageId") Long id, @Context UriInfo uriInfo) {
        ...
        Link selfLink = Link.fromUriBuilder(uriInfo.getBaseUriBuilder()
                        .path(MessageResource.class)
                        .path(Long.toString(newMessage.getId())))
                        .rel("self")
                        .build();

        Link commentsLink = Link.fromUriBuilder(uriInfo.getBaseUriBuilder()
                            .path(MessageResource.class)
        ...
        newMessage.addLink(selfLink);
        newMessage.addLink(commentsLink);
        return newMessage;
}
    ...
    public javax.ws.rs.core.Response createMessage(Message message) {
        ...
        java.net.URI uri = context.getAbsolutePathBuilder()
    ...
    commentResource.setMessageId(messageId);
