 ...
 * 
 */
@WebServiceClient(name = "MyServiceService", targetNamespace = "http://sslserver.mycompany.com/", wsdlLocation = "http://localhost:8080/sslserver/MyServiceService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYSERVICESERVICE_QNAME = new QName("http://sslserver.mycompany.com/", "MyServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/sslserver/MyServiceService?wsdl");
    ...
    public MyService getMyServicePort() {
        return super.getPort(new QName("http://sslserver.mycompany.com/", "MyServicePort"), MyService.class);
    }
    ...
    public MyService getMyServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://sslserver.mycompany.com/", "MyServicePort"), MyService.class, features);
    }
